...
GREEN_TICK_EMOJI_ID = 320324731725152256
RED_TICK_EMOJI_ID = 320324752214458368
GREEN_TICK_EMOJI = 'yes:320324731725152256'
RED_TICK_EMOJI = 'no:320324752214458368'
...
class AdminPlugin(Plugin):
    ...
    def roles(self, event):
        buff = ''
        for role in (sorted(event.guild.roles.values(), key=operator.attrgetter('position'), reverse=True)):
